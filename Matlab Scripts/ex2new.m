...
for s = 1 : 2*(n+1)
    ...
    vec_a(s,1) = (2/(vec_c2(s,1)*2*(n+1)))*sumvectemp1;
end
...
for s = 1 : n+1
    ...
    vec_f(s,1) = (2/(vec_c(s,1)*(n+1)))*sumvectemp2;
end
...
for i = 1 : n+1
    for j = 1 : n+1
    M1(i,j)=vec_a(indice1(i,j));
    end
end

for i = 2 : n+1
    for j = 1 : n+1
    M2(i,j)=vec_a(indice2(i,j));
    end
end
